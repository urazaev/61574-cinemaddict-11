...
export default class PageController {
  ...
  _renderRatedFilms() {
    ...
    this._createRatedFilmsControllers(this._ratedFilms.getTopItems(films), ratingPlace, RATES_CARDS_COUNT);
    this._createRatedFilmsControllers(this._mostCommentedFilms.getTopItems(films), commentsPlace, RATES_CARDS_COUNT);
  }
